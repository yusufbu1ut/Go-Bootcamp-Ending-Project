...
// CreatePagingResponse creates a Pages object using the query parameters found in the given request.
// count stands for the total number of items. Use -1 if this is unknown.
func CreatePagingResponse(g *gin.Context, count int) *Pages {
